...
namespace BehaviorDesigner.Runtime.Tasks.Movement
{
    ...
    public class PursueEntity : NavMeshMovement
    {
        ...
        private Vector3 Target()
        {
            ...
            NavMeshAgent targetNav = target.Value.GetComponent<NavMeshAgent>();
            Vector3 targetVel = targetNav.velocity;
            ...
            targetPosition = target.Value.transform.position;
            return targetPosition + targetVel.normalized * futurePrediction;
        }
